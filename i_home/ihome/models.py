...
class House(BaseModel, db.Model):
    ...
    areage = db.Column(db.Integer, default=0) # 房间面积
    unit = db.Column(db.String(32), default="") # 房间单元， 如
    ...
    order_count = db.Column(db.Integer, default=0) # 预定完成的该房间订单数量
    ...
    def __init__(self, user_id, area_id, title, price, address, room_count, areage, unit,
    ...
    def to_dict(self):
        return{
            ...
            # 'avatar': current_app.config['QINIU_URL'] + self.user.avatar,
...
class Area(BaseModel, db.Model):
    ...
    name = db.Column(db.String(32), nullable=True) # 区域名字
